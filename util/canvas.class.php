	...
	**/
	 ...
	 **/
	 ...
	 private function calculaPosicaoCrop()
	 {
	  ...
	  /** * Junta uma Imagem na principal * * @param $img, $posicao_x, $posicao_y * @return void */ 
	  public function juntarImagem( $imagem, $posicao_x = 0, $posicao_y = 0) { 
	  	$arr_tamanhos = getimagesize( $imagem ); $w_original = $arr_tamanhos[0]; 
		$h_original = $arr_tamanhos[1];
		switch( $this->extensao )
		  {
			   case 'jpg':
			   case 'jpeg':
					$this->formato = 2;
					$img_tmp = imagecreatefromjpeg( $imagem );
					break;
			   case 'gif':
					$this->formato = 1;
					break;
			   case 'png':
					$this->formato = 3;
					$img_tmp = imagecreatefrompng( $imagem );
					break;
			   case 'bmp':
					$this->formato = 6;
					break;
		...
		imagecopy( $this->img, $img_tmp, $posicao_x, $posicao_y, 0, 0, $w_original, $h_original ); return $this; 
		} // fim redimensiona()
